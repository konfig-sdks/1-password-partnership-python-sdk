...
from 1_password_partnership_python_sdk import configuration


class TestCreatePartnerAccountRequest(unittest.TestCase):
    """CreatePartnerAccountRequest unit test stubs"""
    pass
