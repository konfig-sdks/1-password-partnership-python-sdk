...
from 1_password_partnership_python_sdk.paths.api_v1_partners_accounts_customer_account_uid import delete
from 1_password_partnership_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiV1PartnersAccountsCustomerAccountUid(ApiTestMixin, unittest.TestCase):
    """
    ApiV1PartnersAccountsCustomerAccountUid unit test stubs
    """
