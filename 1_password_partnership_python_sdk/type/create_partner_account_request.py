...
class RequiredCreatePartnerAccountRequest(TypedDict):
...
class OptionalCreatePartnerAccountRequest(TypedDict, total=False):
    # Specifies when the 1Password account will be frozen, formatted in RFC-3339.
    ends_at: datetime

class CreatePartnerAccountRequest(RequiredCreatePartnerAccountRequest, OptionalCreatePartnerAccountRequest):
    pass
