...
from 1_password_partnership_python_sdk.paths.api_v1_partners_accounts.post import BeginProvisioningProcessRaw
from 1_password_partnership_python_sdk.paths.api_v1_partners_accounts_customer_account_uid.get import GetByUidRaw
from 1_password_partnership_python_sdk.paths.api_v1_partners_accounts_customer_account_uid.delete import RemoveFromPartnershipRaw
from 1_password_partnership_python_sdk.paths.api_v1_partners_accounts_customer_account_uid.patch import UpdateEndsAtByUidRaw


class AccountApiRaw(
    BeginProvisioningProcessRaw,
    GetByUidRaw,
    RemoveFromPartnershipRaw,
    UpdateEndsAtByUidRaw,
):
    """NOTE:
