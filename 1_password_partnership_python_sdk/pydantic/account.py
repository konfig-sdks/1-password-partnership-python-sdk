...
class Account(BaseModel):
    ...
    customer_account_uid: typing.Optional[str] = Field(None, alias='customer_account_uid')
    ...
    activation_token: typing.Optional[str] = Field(None, alias='activation_token')
    ...
    deployed_members: typing.Optional[int] = Field(None, alias='deployed_members')
