...
SchemaFor410ResponseBodyApplicationJson = ErrorSchema
...
class GetByUidRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_uid(
        self,
        customer_account_uid: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_by_uid_mapped_args(
            customer_account_uid=customer_account_uid,
        )
        return await self._aget_by_uid_oapg(
    ...
    def get_by_uid(
        ...
        return self._get_by_uid_oapg(
            path_params=args.path,
        )

class GetByUid(BaseApi):
    ...
    async def aget_by_uid(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_by_uid(
            customer_account_uid=customer_account_uid,
            **kwargs,
        )
        if validate:
    ...
    def get_by_uid(
        ...
        raw_response = self.raw.get_by_uid(
            customer_account_uid=customer_account_uid,
        )
        if validate:
            return AccountPydantic(**raw_response.body)
